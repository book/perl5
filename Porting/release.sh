...
=item * L<< /Building a release - advance actions >>

=item * L<< /Dual-life CPAN module synchronisation >>

=item * L<< /Sync CPAN modules with the corresponding cpanE<sol> distro >>

=item * L<< /Ensure dual-life CPAN module stability >>

=item * L<< /Monitor smoke tests for failures >>

=item * L<< /Check POD errors >>

=item * L<< /Update perldelta >>

=item * L<< /Update INSTALL >>

=item * L<< /Update AUTHORS >>

=item * L<< /Check copyright years >>

=item * L<< /Check more build configurations >>

=item * L<< /Update perlport >>

=item * L<< /Check a readonly build >>

=back

=item * L<< /Building a release - on the day >>

=over 8

=item * L<< /Re-check earlier actions >>

=item * L<< /Create a release branch >>

=item * L<< /Build a clean perl >>

=item * L<< /Check module versions >>

=item * L<< /Update Module::CoreList >>

=over 12

=item * L<< /Bump Module::CoreList* $VERSIONs >>

=item * L<< /Update C<Module::CoreList> with module version data for the new release >>

=item * L<< /Bump version in Module::CoreList F<Changes> >>

=item * L<< /Add Module::CoreList version bump to perldelta >>

=item * L<< /Update C<%Module::CoreList::released> >>

=item * L<< /Commit Module::CoreList changes >>

=item * L<< /Rebuild and test >>

=back

=item * L<< /Finalize perldelta >>

=item * L<< /Update and commit perldelta files >>

=item * L<< /Final check of perldelta placeholders >>

=item * L<< /Build a clean perl >>

=item * L<< /Update perlhist.pod >>

=item * L<< /Run makemeta to update META files >>

=item * L<< /Build, test and check a fresh perl >>

=item * L<< /Create the release tag >>

=item * L<< /Build the tarball >>

=item * L<< /Test the tarball >>

=over 12

=item * L<< /Copy the tarball to a web server >>

=item * L<< /Download the tarball to another machine and unpack it >>

=item * L<< /Ask #p5p to test the tarball on different platforms >>

=item * L<< /Check that F<Configure> works >>

=item * L<< /Run the test harness and install >>

=item * L<< /Check C<perl -v> and C<perl -V> >>

=item * L<< /Run the Installation Verification Procedure utility >>

=item * L<< /Compare the installed paths to the last release >>

=item * L<< /Disable C<local::lib> if it's turned on >>

=item * L<< /Bootstrap the CPAN client >>

=item * L<< /Install the Inline module with CPAN and test it >>

=item * L<< /Make sure that perlbug works >>

=back

=item * L<< /Upload to PAUSE >>

=item * L<< /Announce to p5p >>

=item * L<< /Merge release branch back to blead >>

=item * L<< /Publish the release tag >>

=item * L<< /Update epigraphs.pod >>

=item * L<< /Release schedule >>

=item * L<< /Module::CoreList nagging >>

=item * L<< /New perldelta >>

=item * L<< /Push commits >>

=item * L<< /Bump the version number >>

=item * L<< /Clean build and test >>

=item * L<< /Relax! >>

=back

=item * L<< /Building a release - the day after >>

=over 8

=item * L<< /Update Module::CoreList >>

=item * L<< /Check tarball availability >>

=item * L<< /Update release manager's guide >>

=item * L<< /For a BLEAD-POINT .0 release >>
...
can be found in Porting/release_schedule.pod.
...
Be particularly careful with the section "Upgrading from 5.43.7 or earlier".
...
entries or removing any entries, then commit your changes.
 ...
 $ git commit -a AUTHORS -m 'Update AUTHORS list for 5.43.7'
...
running:
 ...
 $ ./perl -Ilib Porting/cmpVERSION.pl --tag=v5.43.6
...
cherry-pick it back).
 ...
 $ git commit -m 'Update Module::CoreList for 5.43.7' dist/Module-CoreList/Changes dist/Module-CoreList/lib/Module/CoreList.pm dist/Module-CoreList/lib/Module/CoreList/Utils.pm
...
section, which can be generated with something like:
 ...
 $ perl Porting/acknowledgements.pl v5.43.6..HEAD
...
Build perl, then make sure it passes its own test suite, and installs:
 ...
 $ git clean -xdf
 $ ./Configure -des -Dprefix=/tmp/perl-5.43.7-pretest
...
C</tmp/perl-5.43.7-pretest/bin/perl5.43.7> rather than
C</tmp/perl-5.43.7-pretest/bin/perl>.

Check that the output of C</tmp/perl-5.43.7-pretest/bin/perl -v> and
C</tmp/perl-5.43.7-pretest/bin/perl -V> are as expected,
...
C<perl -v> (or C<perl5.43.7 -v>) will identify itself as:

 This is perl 5, version X, subversion Y (v5.43.7 (v5.XX.Z-NNN-gdeadbeef))

where 5.43.Z is the latest tag, NNN the number of commits since this tag,
...
Check that your perl can run this:
 ...
 $ bin/perl5.43.7 -lwe "use Inline C => q[int f() { return 42;}]; print f"
 42
...
you have it configured:
 ...
 $ cpan-upload perl-5.43.7.tar.gz
 $ cpan-upload perl-5.43.7.tar.xz
...
You can also check
 ...
 https://metacpan.org/release/YOUR_PAUSE_ID/perl-5.43.7
...
Merge the (local) release branch back into master now, and delete it.
 ...
 $ git checkout blead
 $ git pull
 $ git merge release-5.43.7
 $ git push
 $ git branch -d release-5.43.7
...
When C<make test_porting> passes, commit the new perldelta.
 ...
 $ git commit -m'Archive perldelta 5.43.7'
...
Commit your changes:
 ...
 $ git commit -a -m 'Bump the perl version in various places for 5.43.7'
